 ...
 * @see TableStyle class is derived from <b>Symfony/Console</b>
 */
...
class TableStyle
{
    ...
    public function setPaddingChar(string $paddingChar)
    {
        ...
        if (!$paddingChar) {
            ...
            throw new \RuntimeException('The padding char must not be empty');
    ...
    public function setPadType(int $padType)
    {
        ...
        if (!\in_array($padType, [STR_PAD_LEFT, STR_PAD_RIGHT, STR_PAD_BOTH], true)) {
            ...
            throw new \RuntimeException('Invalid padding type. Expected one of (STR_PAD_LEFT, STR_PAD_RIGHT, STR_PAD_BOTH).');
