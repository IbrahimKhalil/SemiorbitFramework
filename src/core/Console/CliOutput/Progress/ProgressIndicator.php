 ...
 * @see ProgressIndicator class is derived from <b>Symfony/Console</b>
 */
...
class ProgressIndicator
{
    ...
    public function __construct(Output $output, string $format = null, int $indicatorChangeInterval = 100, array $indicatorValues = null)
    {
        ...
        if (2 > \count($indicatorValues)) {
            ...
            throw new \RuntimeException('Must have at least 2 indicator value characters.');
    ...
    public function Start(string $message)
    {
        if ($this->started) {
            ...
            throw new \RuntimeException('Progress indicator already started.');
    ...
    public function Advance()
    {
        ...
        if (!$this->started) {
            ...
            throw new \RuntimeException('Progress indicator has not yet been started.');
