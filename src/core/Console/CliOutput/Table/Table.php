...
use Semiorbit\Console\CliOutput\OutputFormatter;
 ...
 * @see Table class is derived from <b>Symfony/Console</b>
 */
...
class Table
{
    ...
    public static function getStyleDefinition(string $name)
    {
        ...
        throw new \RuntimeException(sprintf('Style "%s" is not defined.', $name));
    ...
    public function setColumnMaxWidth(int $columnIndex, int $width): self
    {
        ...
        if (!$this->output->getFormatter() instanceof OutputFormatter) {
    ...
    public function AddRow($row)
    {
        ...
        if (!\is_array($row)) {
            ...
            throw new \RuntimeException('A row must be an array or a TableSeparator instance.');
    ...
    private function FillNextRows(array $rows, int $line): array
    {
        ...
        foreach ($rows[$line] as $column => $cell) {
            ...
            if (null !== $cell && !$cell instanceof TableCell && !is_scalar($cell) && !(\is_object($cell) && method_exists($cell, '__toString'))) {
                ...
                throw new \RuntimeException(sprintf('A cell must be a TableCell, a scalar or an object implementing __toString, %s given.', \gettype($cell)));
