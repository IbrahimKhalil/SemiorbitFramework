 ...
 * @see StreamOutput class is derived from <b>Symfony/Console</b>
 */
...
class StreamOutput extends Output
{
     ...
     *
     * @throws \RunTimeException When first argument is not a real stream
     */
    ...
    public function __construct($stream, int $verbosity = self::VERBOSITY_NORMAL, bool $decorated = null, OutputFormatter $formatter = null)
    {
        ...
        if (!\is_resource($stream) || 'stream' !== get_resource_type($stream)) {
            ...
            throw new \RunTimeException('The StreamOutput class needs a stream as its first argument.');
